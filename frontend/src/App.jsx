...
function getOfflineDemoState(area = 'chennai') {
  ...
  const cityData = {
    ...
    coimbatore: [
      ["C1", "Gandhipuram", 140000, 11.0168, 76.9558, 0.5, 50.0, "MEDIUM"],
      ["C2", "Singanallur", 125000, 11.0000, 77.0200, 0.8, 95.0, "CRITICAL"],
      ["C3", "Peelamedu", 110000, 11.0250, 76.9950, 0.3, 30.0, "LOW"],
      ["C4", "Ukadam", 135000, 10.9900, 76.9600, 0.7, 75.0, "HIGH"],
      ["C5", "R.S. Puram", 95000, 11.0080, 76.9480, 0.2, 20.0, "LOW"],
    ],
    madurai: [
      ["M1", "Simmakkal", 160000, 9.9252, 78.1198, 0.6, 65.0, "HIGH"],
      ["M2", "Goripalayam", 140000, 9.9350, 78.1300, 0.9, 110.0, "CRITICAL"],
      ["M3", "Anna Nagar", 120000, 9.9200, 78.1500, 0.3, 35.0, "LOW"],
      ["M4", "Mattuthavani", 130000, 9.9500, 78.1550, 0.4, 45.0, "MEDIUM"],
      ["M5", "Tiruparankundram", 105000, 9.8800, 78.0800, 0.2, 25.0, "LOW"],
    ],
    cuddalore: [
      ["CD1", "OT Sector", 115000, 11.7480, 79.7714, 0.9, 130.0, "CRITICAL"],
      ["CD2", "Manjakuppam", 95000, 11.7580, 79.7650, 0.6, 70.0, "HIGH"],
      ["CD3", "Silver Beach Sector", 70000, 11.7300, 79.7850, 0.8, 105.0, "CRITICAL"],
      ["CD4", "Semmandalam", 60000, 11.7650, 79.7500, 0.3, 35.0, "LOW"],
    ],
    thoothukudi: [
      ["TK1", "Harbor Sector", 130000, 8.7642, 78.1348, 0.95, 140.0, "CRITICAL"],
      ["TK2", "Thermal Power Sector", 85000, 8.7400, 78.1600, 0.7, 85.0, "HIGH"],
      ["TK3", "Palayamkottai Road", 110000, 8.7800, 78.1200, 0.4, 50.0, "MEDIUM"],
      ["TK4", "Sipcot Hub", 65000, 8.8100, 78.1000, 0.2, 20.0, "LOW"],
    ],
    chennai: [
